...
Para una muestra de $n=50$ de la edad de los participantes de la Carrera La Luz inicalmente se verifica si su distribución es normal con el fin de determinar que prueba utilizar. Cumplido este supuesto y al no tener conocimiento del valor de la varianza utilizaremos una **prueba t** para una media
...
**Conclusión**: Como el **EdeP** (`t = 0.76215`) NO cae en la **RdeR**, entonces NO rechazamos $Ho$, asuminos $Ho$ es verdadera, es decir ASUMIMOS  que $\mu$ de las edades   es igual a 31 años. 
