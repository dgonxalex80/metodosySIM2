...
Además se presentan tres alernativas para el estadístico de prueba:
...
```
El resultado indica que la mayoria de los participantes son hombres

<br/><br/>

## <span style="color:#034a94">**Para la comparación de medias en grupos independientes**</span>

Previamente a realizar la comparación de medias se deben realizar las pruebas de normalidad para cada una de las variables, en caso de asumir que las variables tienen distribución nomral, se procede a comparar las varianzas de los dos grupos  y dependiendo el resultado obtenido se procede a realizar la comparación de medias. en caso de no obtener normalidad o de que las variables procedan de mediciones a través de test en escalas de intercalo (caso de mediciones de clima laboral, nivel de estres, percepcines, entre otros) o de poseer pocos datos se recomienda emplear métodos no paramétricos.
...
Los reultados indican que los promedios se supomen iguales
