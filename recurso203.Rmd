...
La cantidad de ácido ($X$) y la cantidad de ácido ($Y$), en litros, que se vierten en una mezcla se modela con la función fXY como se presenta a continuación $f(x,y)$ esta dada por: 
