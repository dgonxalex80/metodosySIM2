...
Las probabilidade puede definirse para eventos simples ($A$, $B$,...) o compuestos ($(A \cup B)$, $(A \cap B)$, $(B|A)$ ) que incluyen varios eventos.   Dependiendo el tipo de evento puede tomar los siguientes nombres: 
...
**Figura 2.5** Dispocisión de compomentes en serie
</center>
...
**Figura 2.6** Dispocisión de compomentes en paralelo
</center>
...
```
**Figura 2.7** Árbol de probabilidades margiles y condicionales
</center>
...
En una fábrica de artículos para protección biodegradables, cuatro operarios colocan etiquetas de caducidad en cada
