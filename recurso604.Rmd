...
## **Inrtevalo de confianza para una media**


Como ejemplo se estima un IC para la el tiempo de carrera de los participantes en la carrera La Luz 2022, para una muestra de n=100 competidores
...
Como el resultado obtenido contiene a cero,  indica que  las proporciones son similares
