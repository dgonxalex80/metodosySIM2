...
Distribuciones normales : <span style="color:#034A94">$X \sim N(0,1)$</span>, <span style="color:#FF7F00"> $X \sim N(0,1.5)$</span> y <span style="color:#686868"> $X \sim N(2,1.5)$</span>
...
### <span style="color:#034a94">**Distribución normal estandar N(0,1)**</span>
...
### <span style="color:#034a94">**normal estándar**</span>
...
### <span style="color:#034a94">**Propiedad empírica de la distribución normal estandar**</span>
...
Distribuciones exponenciales : <span style="color:#FF7F00"> $X\sim exp(x,\lambda=1)$</span>, <span style="color:#034A94"> $X\sim exp(x,\lambda=2)$</span> y <span style="color:#686868"> $X\sim exp(x,\lambda=5)$</span>
...
### <span style="color:#034a94">**Distribución exponencial acumulad**</span>
...
Distribuciones : <span style="color:#FF7F00">$X\sim gamma(x, \alpha=3,\beta=1)$</span>, <span style="color:#034A94">$X\sim gamma(x, \alpha=2,\beta=1)$</span> y <span style="color:#686868">$X\sim gamma(x, \alpha=5,\beta=1)$</span>
...
Distribuciones : <span style="color:#FF7F00">$X \sim Weibull(0.8, 1)$</span>, <span style="color:#034A94"> $X \sim Weibul(2,1)$</span> y <span style="color:#686868"> $X \sim Weibull(2,2)$</span>
