...
Como el **EdeP** (`t = 0.76215`) NO cae en la **RdeR**, entonces NO rechazamos $Ho$, asumimos $Ho$ es verdadera, es decir ASUMIMOS  que $\mu$ de las edades   es igual a 31 años. 
...
Como el valor de $\alpha > valor-p$  ($0.05 > p-value = 0.4496$ ) entonces No se rechaza $Ho$, se **asume** que 	$Ho$ es verdad. ASUMIMOS  que $\mu$ de las edades   es igual a 31 años.  
...
En este caso valoramos si el valor-p (p-value =  0.4496) si es grande o pequeño. En esta caso se puede considerar que su valor es muy grande y por lo tanto no nos atrevemos a rechazar $Ho$, asumimos que $Ho$ es verdadera, ASUMIMOS  que $\mu$ de las edades   es igual a 31 años. 
