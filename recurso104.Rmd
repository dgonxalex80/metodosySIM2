...
Las probabilidade puede definirse para eventos simples ($A$, $B$,...) o compuestos ($(A \cup B)$, $(A \cap B)$, $(B|A)$ ) que inclugen varios eventos.   Dependiendo el tipo de evento puede tomar los siguientes nombres: 
